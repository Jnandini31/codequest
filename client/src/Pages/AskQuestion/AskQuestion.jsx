...
const handlesubmit = (e)=>{
    ...
    if(user){
      if(questionbody && questiontitle && questiontag){
        dispatch(AskQuestion({questiontitle, questionbody,userPosted: user.result.name },navigate));
        ...
        <form onSubmit={handlesubmit}>
          <div className="ask-form-container">
            <label htmlFor="ask-ques-title">
              <h4>Title</h4>
              <p>Be specific and imagine you're asking a question to another perosn</p>
            ...
            <label htmlFor="ask-ques-tags">
              <h4>Tags</h4>
              <p>Add up to 5 tags to describe what a question is about</p>
